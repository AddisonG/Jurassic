...
set MECH_ENGINE_List[0]=0x49303035
set MECH_ENGINE_FuelTank[0]=0x4130304D
set MECH_ENGINE_Refuel[0]=0x41303133
set MECH_ENGINE_Speed[0]=0x41303053
set MECH_ENGINE_Usage[0]=0x4130305A
set MECH_ENGINE_List[1]=0x49303036
set MECH_ENGINE_FuelTank[1]=0x4130304E
set MECH_ENGINE_Refuel[1]=0x4130314F
set MECH_ENGINE_Speed[1]=0x41303054
set MECH_ENGINE_Usage[1]=0x4130305A
set MECH_ENGINE_List[2]=0x49303037
set MECH_ENGINE_FuelTank[2]=0x4130304F
set MECH_ENGINE_Refuel[2]=0x41303150
set MECH_ENGINE_Speed[2]=0x41303055
set MECH_ENGINE_Usage[2]=0x41303130
set MECH_ENGINE_List[3]=0x49303038
set MECH_ENGINE_FuelTank[3]=0x4130304F
set MECH_ENGINE_Refuel[3]=0x41303151
set MECH_ENGINE_Speed[3]=0x41303056
set MECH_ENGINE_Usage[3]=0x4130305A
set MECH_ENGINE_List[4]=0x49303039
set MECH_ENGINE_FuelTank[4]=0x41303050
set MECH_ENGINE_Refuel[4]=0x41303152
set MECH_ENGINE_Speed[4]=0x41303057
set MECH_ENGINE_Usage[4]=0x41303131
set MECH_ENGINE_List[5]=0x49303041
set MECH_ENGINE_FuelTank[5]=0x41303051
set MECH_ENGINE_Refuel[5]=0x41303153
set MECH_ENGINE_Speed[5]=0x41303058
set MECH_ENGINE_Usage[5]=0x41303131
set MECH_ENGINE_List[6]=0x49303042
set MECH_ENGINE_FuelTank[6]=0x41303052
set MECH_ENGINE_Refuel[6]=0x41303153
set MECH_ENGINE_Speed[6]=0x41303059
set MECH_ENGINE_Usage[6]=0x41303132
set MECH_CHASSIS_List[0]=0x49303049
set MECH_CHASSIS_Armour[0]=0x41303142
set MECH_CHASSIS_Health[0]=0x41303149
set MECH_CHASSIS_Speed[0]=0x41303134
set MECH_CHASSIS_List[1]=0x4930304A
set MECH_CHASSIS_Armour[1]=0x41303143
set MECH_CHASSIS_Health[1]=0x4130314A
set MECH_CHASSIS_Speed[1]=0x41303135
set MECH_CHASSIS_List[2]=0x4930304B
set MECH_CHASSIS_Armour[2]=0x41303144
set MECH_CHASSIS_Health[2]=0x4130314B
set MECH_CHASSIS_Speed[2]=0x41303136
set MECH_CHASSIS_List[3]=0x4930304C
set MECH_CHASSIS_Armour[3]=0x41303145
set MECH_CHASSIS_Health[3]=0x4130314B
set MECH_CHASSIS_Speed[3]=0x41303137
set MECH_CHASSIS_List[4]=0x4930304D
set MECH_CHASSIS_Armour[4]=0x41303146
set MECH_CHASSIS_Health[4]=0x4130314C
set MECH_CHASSIS_Speed[4]=0x41303135
set MECH_CHASSIS_List[5]=0x4930304E
set MECH_CHASSIS_Armour[5]=0x41303147
set MECH_CHASSIS_Health[5]=0x4130314D
set MECH_CHASSIS_Speed[5]=0x41303138
set MECH_CHASSIS_List[6]=0x4930304F
set MECH_CHASSIS_Armour[6]=0x41303144
set MECH_CHASSIS_Health[6]=0x4130314C
set MECH_CHASSIS_Speed[6]=0x41303139
set MECH_CHASSIS_List[7]=0x49303050
set MECH_CHASSIS_Armour[7]=0x41303148
set MECH_CHASSIS_Health[7]=0x4130314E
set MECH_CHASSIS_Speed[7]=0x41303141
endfunction
...
if ( ( GetItemTypeId(GetManipulatedItem()) == 0x49303051 ) ) then
return true
endif
if ( ( GetItemTypeId(GetManipulatedItem()) == 0x49303052 ) ) then
return true
endif
...
if ( ( GetItemTypeId(GetManipulatedItem()) == 0x49303056 ) ) then
return true
endif
return false
endfunction
...
if ( not ( GetItemTypeId(GetManipulatedItem()) == 0x49303051 ) ) then
return false
endif
return true
endfunction
function Trig_Mechanic_Recipie_Func009C takes nothing returns boolean
if ( not ( GetItemTypeId(GetManipulatedItem()) == 0x49303052 ) ) then
return false
endif
return true
endfunction
...
if ( not ( GetItemTypeId(GetManipulatedItem()) == 0x49303053 ) ) then
return false
endif
return true
endfunction
function Trig_Mechanic_Recipie_Func013C takes nothing returns boolean
if ( not ( GetItemTypeId(GetManipulatedItem()) == 0x49303054 ) ) then
return false
endif
return true
endfunction
...
if ( not ( GetItemTypeId(GetManipulatedItem()) == 0x49303056 ) ) then
return false
endif
return true
endfunction
...
call CreateNUnitsAtLoc(1 , 0x68303047 , GetOwningPlayer(GetTriggerUnit()) , udg_TEMP_Point_1 , bj_UNIT_FACING)
call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit() , 0x49303051))
set udg_TEMP_Real = 1.00
else
endif
if ( Trig_Mechanic_Recipie_Func009C() ) then
call CreateNUnitsAtLoc(1 , 0x68303047 , GetOwningPlayer(GetTriggerUnit()) , udg_TEMP_Point_1 , bj_UNIT_FACING)
call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit() , 0x49303052))
set udg_TEMP_Real = 1.00
else
endif
if ( Trig_Mechanic_Recipie_Func011C() ) then
call CreateNUnitsAtLoc(1 , 0x68303048 , GetOwningPlayer(GetTriggerUnit()) , udg_TEMP_Point_1 , bj_UNIT_FACING)
call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit() , 0x49303053))
set udg_TEMP_Real = 1.00
else
endif
if ( Trig_Mechanic_Recipie_Func013C() ) then
call CreateNUnitsAtLoc(1 , 0x6E303039 , GetOwningPlayer(GetTriggerUnit()) , udg_TEMP_Point_1 , bj_UNIT_FACING)
call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit() , 0x49303054))
set udg_TEMP_Real = 1.00
else
endif
if ( Trig_Mechanic_Recipie_Func015C() ) then
call CreateNUnitsAtLoc(1 , 0x6E303035 , GetOwningPlayer(GetTriggerUnit()) , udg_TEMP_Point_1 , bj_UNIT_FACING)
call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit() , 0x49303055))
set udg_TEMP_Real = 1.00
else
endif
if ( Trig_Mechanic_Recipie_Func017C() ) then
call CreateNUnitsAtLoc(1 , 0x6E303042 , GetOwningPlayer(GetTriggerUnit()) , udg_TEMP_Point_1 , bj_UNIT_FACING)
call RemoveItem(GetItemOfTypeFromUnitBJ(GetTriggerUnit() , 0x49303056))
set udg_TEMP_Real = 1.00
else
endif
