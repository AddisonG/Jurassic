void Game_Start_Actions() {
	debug BJDebugMsg("Game_Start_Actions")
	...
	TimerStart(START_TIMER, 120 - 12 * DIFFICULTY, false, null)
	timerdialog timer_msg = CreateTimerDialog(START_TIMER)
	TimerDialogSetTitle(timer_msg, "Grace period")
...
void InitTrig_Game_Start() {
	debug BJDebugMsg("InitTrig_Game_Start")
